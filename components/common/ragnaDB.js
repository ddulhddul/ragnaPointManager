...
const itemIngredientsList = [
  {price: 0,    name: "2018.3월 뽑기"}, 
  {price: 0,    name: "2018.4월 뽑기"}, 
  {price: 0,    name: "2018.5월 뽑기"}, 
  {price: 0,    name: "2018.6월 뽑기"}, 
  {price: 0,    name: "EP 2.0 특전 구매"}, 
  {price: 0,    name: "가렛"}, 
  {price: 0,    name: "갈색 염료"}, 
  {price: 0,    name: "강철"}, 
  {price: 0,    name: "검은 염료"}, 
  {price: 0,    name: "괘종시계"}, 
  {price: 0,    name: "구멍난 빨간 양말"}, 
  {price: 0,    name: "꿀"}, 
  {price: 0,    name: "끈적끈적한 액체"}, 
  {price: 0,    name: "네잎 클로버"}, 
  {price: 0,    name: "노란 염료"}, 
  {price: 0,    name: "눈사람"}, 
  {price: 0,    name: "단단한 껍질"}, 
  {price: 0,    name: "더듬이"}, 
  {price: 0,    name: "드래곤의 비늘"}, 
  {price: 0,    name: "리본 끈"}, 
  {price: 0,    name: "마녀의 별모래"}, 
  {price: 0,    name: "마스테라의 열매"}, 
  {price: 0,    name: "만드라"}, 
  {price: 0,    name: "망자의 유물"}, 
  {price: 0,    name: "방울"}, 
  {price: 0,    name: "별의 모서리"}, 
  ...
  {price: 0,    name: "셀"}, 
  {price: 0,    name: "송곳니"}, 
  {price: 0,    name: "수정으로 만든 거울"}, 
  {price: 0,    name: "시간 왜곡 버튼"}, 
  {price: 0,    name: "시간의 결정"}, 
  {price: 0,    name: "시계탑의 열쇠"}, 
  {price: 0,    name: "심연의 꽃"}, 
  {price: 0,    name: "썩은 붕대"}, 
  {price: 0,    name: "아메디스트"}, 
  {price: 0,    name: "아쿠아마린"}, 
  {price: 0,    name: "악마의 뿔"}, 
  {price: 0,    name: "어둠에 잠긴 칼날"}, 
  {price: 0,    name: "얼음 가루"}, 
  {price: 0,    name: "얼음 심장"}, 
  {price: 0,    name: "얼음 조각"}, 
  {price: 0,    name: "오크워리어 증표"}, 
  {price: 0,    name: "오크의 손톱"}, 
  {price: 0,    name: "오크히어로의 증표"}, 
  {price: 0,    name: "유리구슬"}, 
  {price: 0,    name: "자르곤"}, 
  {price: 0,    name: "장미석영"}, 
  {price: 0,    name: "저주받은 루비"}, 
  {price: 0,    name: "젤로피"}, 
  {price: 0,    name: "진주"}, 
  {price: 0,    name: "질콘"}, 
  {price: 0,    name: "철"}, 
  {price: 0,    name: "초록 염료"}, 
  {price: 0,    name: "크리스마스 화환"}, 
  {price: 0,    name: "크리스탈 뼈"}, 
  {price: 0,    name: "토파즈"}, 
  {price: 0,    name: "투명한 천조각"}, 
  {price: 0,    name: "파란 염료"}, 
  {price: 0,    name: "핏빛의 룬"}, 
  {price: 0,    name: "하얀 염로"}, 
  {price: 0,    name: "하얀 염료"}, 
